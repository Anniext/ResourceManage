...
const MySQLDSN = "root:123456@(8.142.129.250:33060)/rema?charset=utf8mb4&parseTime=True&loc=Local"
...
func GenGenerate() {
	...
	//keytag["foreignKey"] = "user_id"
	//// 创建user和unit的关联模型
	//User := g.GenerateModel("sys_backend_user",
	//	append(
	//		fieldOpts,
	//		// user 一对多 address 关联, 外键`uid`在 address 表中
	//		gen.FieldRelate(field.HasMany, "Unit", Unit, &field.RelateConfig{GORMTag: keytag}),
